    ...
    <table class="style15" style="background-image: url('Photo/colorful.png');">
        <tr>
            <td>
                &nbsp;</td>
            <td>
                <asp:Label ID="lblSessionWelcome" runat="server" Text="Welcome "></asp:Label>
            </td>
            <td colspan="2">
        ...
        <tr>
            ...
            <td>
                &nbsp;</td>
            <td>
                <asp:Button ID="btnREinvitation" runat="server" Text="Report Invitation" 
        ...
        <tr>
            ...
            <td class="style16">
                <asp:Button ID="btnREcontactUS" runat="server" Text="Report Complaints" 
