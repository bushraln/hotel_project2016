...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        ...
        <td class="style2">
            &nbsp;</td>
        <td>
            <asp:Label ID="LblMsnSub" runat="server" Text="Message Subject" 
    ...
    <tr>
        ...
        <td class="style2">
            &nbsp;</td>
        <td>
            <asp:Label ID="lblREemail" runat="server" Text="Replay Email" 
                style="font-family: 'Bradley Hand ITC'; font-weight: 700"></asp:Label>
        </td>
        <td>
            &nbsp;</td>
    ...
    <tr>
        ...
        <td style="background-position: bottom">
            &nbsp;</td>
        <td style="background-position: bottom">
            <asp:Button ID="btnSend" runat="server" Text="Send" ValidationGroup="1" OnClick="btnSend_Click" />
        </td>
        <td style="background-position: bottom">
            &nbsp;</td>
        <td style="background-position: bottom">
